...
/**
 * Adapted from org.wicketstuff.wicket.servlet3.auth.ServletContainerAuthenticatedWebApplication without final for extensibility.
 */
@SecureAutoMount
public abstract class JPPFServletContainerAuthenticatedWebApplication extends AuthenticatedWebApplication
{

	/**
	 * Logger for this class.
	 */
	private static final Logger LOG = LoggerFactory.getLogger(JPPFServletContainerAuthenticatedWebApplication.class);
	...
	protected abstract Class<? extends JPPFServletContainerAuthenticatedWebSession> getContainerManagedWebSessionClass();
	 ...
	 * unauthorized access.
	 */
	private final class ContainerSecurityInterceptorListener implements IRequestCycleListener, IUnauthorizedComponentInstantiationListener
	{
		...
		public void onRequestHandlerScheduled(final RequestCycle cycle, final IRequestHandler handler)
		{
			if (handler instanceof IPageClassRequestHandler)
			{
				...
				if (!authorized)
				{
					if (!JPPFServletContainerAuthenticatedWebSession.get().isSignedIn())
					{
		...
		public void onUnauthorizedInstantiation(final Component component)
		{
			...
			} else
			{
				...
				JPPFServletContainerAuthenticatedWebApplication.this.onUnauthorizedInstantiation(component);
			}
		}
	}
}
